...
_ACTIVE_BY_NAME = {
    ...
    # Painel do Dono
    "painel:index": "painel",
    "painel:reports": "painel",
    "painel:user_list": "painel",
    "painel:user_detail": "painel",
    "painel:user_toggle": "painel",
    "painel:plan_list": "painel",
    "painel:plan_create": "painel",
    "painel:plan_edit": "painel",
    "painel:plan_toggle": "painel",
    "painel:coupon_list": "painel",
    "painel:coupon_create": "painel",
    "painel:coupon_toggle": "painel",
    "painel:subscription_list": "painel",
    "painel:subscription_grant": "painel",
    "painel:subscription_cancel": "painel",
    "painel:payment_list": "painel",
    "painel:payment_create": "painel",
    "painel:payment_mark_paid": "painel",
    "painel:payment_refund": "painel",
            ...
            nav_items.append(
                {
                    ...
                    "children": [
                        ...
                        {"key": "painel_relatorios", "label": "Relatórios", "icon": "▦",
                         "url": reverse("painel:reports"), "track": "nav.painel.relatorios"},
                        {"key": "painel_usuarios", "label": "Usuários", "icon": "☰",
                         "url": reverse("painel:user_list"), "track": "nav.painel.usuarios"},
                        {"key": "painel_assinaturas", "label": "Assinaturas", "icon": "◈",
                         "url": reverse("painel:subscription_list"), "track": "nav.painel.assinaturas"},
                        {"key": "painel_pagamentos", "label": "Pagamentos", "icon": "R$",
                         "url": reverse("painel:payment_list"), "track": "nav.painel.pagamentos"},
                        {"key": "painel_planos", "label": "Planos", "icon": "▤",
                         "url": reverse("painel:plan_list"), "track": "nav.painel.planos"},
                        {"key": "painel_cupons", "label": "Cupons", "icon": "%",
                         "url": reverse("painel:coupon_list"), "track": "nav.painel.cupons"},
                        {"key": "painel_monetizacao", "label": "Monetização", "icon": "⚙",
